...
export const generateImageTool: Tool<GenerateImageArgs> = {
  ...
  parameters: {
    ...
    properties: {
      ...
      width: { type: 'number', description: 'Image width in pixels, 64 to 1024 and a multiple of 64. With safe_preset omitted/true, forced to 512; with safe_preset false, defaults to 512.' },
      height: { type: 'number', description: 'Image height in pixels, 64 to 1024 and a multiple of 64. With safe_preset omitted/true, forced to 768; with safe_preset false, defaults to 768.' },
      steps: { type: 'number', description: 'Diffusion step count. With safe_preset omitted/true, forced to 20; with safe_preset false, defaults to 30.' },
      cfg_scale: { type: 'number', description: 'Classifier-free guidance scale. With safe_preset omitted/true, forced to 7; with safe_preset false, defaults to 7, or 6 when realism_preset is true.' },
      seed: { type: 'number', description: 'Optional generation seed.' },
      count: { type: 'number', description: 'Number of images to generate, 1 to 4. With safe_preset omitted/true, forced to 1; with safe_preset false, defaults to 1.' },
      realism_preset: { type: 'boolean', description: 'Whether to apply conservative non-safe defaults for more realistic photos when safe_preset is false. Defaults to false.' },
      hires_fix: { type: 'boolean', description: 'Whether to run a high-resolution upscale plus low-denoise img2img pass. With safe_preset omitted/true, forced to true; with safe_preset false, defaults to false.' },
      hires_scale: { type: 'number', description: 'Hires upscale factor, 1 to 4. With safe_preset omitted/true, forced to 2; with safe_preset false, defaults to 2.' },
      hires_steps: { type: 'number', description: 'Hires img2img step count. With safe_preset omitted/true, forced to 15; with safe_preset false, defaults to 15.' },
      hires_denoise: { type: 'number', description: 'Hires img2img denoising strength, 0.05 to 0.5. With safe_preset omitted/true, forced to 0.15; with safe_preset false, defaults to 0.15.' },
      bmab_postprocess: { type: 'boolean', description: 'Whether to apply lightweight BMAB-like noise, contrast, brightness, and color-temperature postprocess. With safe_preset omitted/true, forced to true; with safe_preset false, defaults to false.' },
      ...
      eye_refine: { type: 'boolean', description: 'Whether to run an extra low-strength eye-area refine pass after face detection. With safe_preset omitted/true, forced to true; with safe_preset false, defaults to false.' },
      eye_refine_strength: { type: 'number', description: 'Eye refine denoising strength, 0.05 to 0.3. With safe_preset omitted/true, forced to 0.12; with safe_preset false, defaults to 0.12.' },
      eye_refine_steps: { type: 'number', description: 'Eye refine img2img step count. With safe_preset omitted/true, forced to 12; with safe_preset false, defaults to 12.' },
      detail_enhance: { type: 'boolean', description: 'Whether to run optional detail enhancement after generation. With safe_preset omitted/true, forced to true; with safe_preset false, defaults to false.' },
      detail_targets: { type: 'string', enum: ['auto', 'face', 'hand', 'person'], description: 'Detail enhancement target selection. With safe_preset omitted/true, forced to face; with safe_preset false, defaults to auto.' },
      detail_strength: { type: 'number', description: 'Detail enhancement denoising strength, 0.1 to 0.7. With safe_preset omitted/true, forced to 0.1; with safe_preset false, defaults to 0.35, or 0.2 when realism_preset is true.' },
      safe_preset: { type: 'boolean', description: 'When omitted or true, force the M3 16 GB safe preset values and report any overridden caller values in preset_adjustments. Set false to use explicit values or the non-safe/internal defaults.' },
      dynamic_thresholding: { type: 'boolean', description: 'Whether to enable Dynamic Thresholding. With safe_preset omitted/true, forced to true; with safe_preset false, defaults to true.' },
      dynamic_thresholding_mimic_scale: { type: 'number', description: 'Dynamic Thresholding mimic scale, 1 to 20. With safe_preset omitted/true, forced to 7; with safe_preset false, defaults to 7.' },
      dynamic_thresholding_percentile: { type: 'number', description: 'Dynamic Thresholding percentile, greater than 0.9 and less than 1. With safe_preset omitted/true, forced to 0.995; with safe_preset false, defaults to 0.995.' },
