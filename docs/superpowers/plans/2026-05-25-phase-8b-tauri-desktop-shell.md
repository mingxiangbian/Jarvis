...
- Create: `tests/tauri-config.test.ts`
- Modify: `package.json`
- Modify: `package-lock.json`

- [x] **Step 1: Generate scaffold through official CLI**
...
- [x] **Step 2: Normalize Tauri config**
...
- [x] **Step 4: Verify Tauri config is parseable**
